...
namespace GEOWALL_E
{
    class Evaluador
    {
        ...
        object Evaluar_Expresion(Expresion nodo)
        {
            ...
            if(nodo is Punto l)
            {
                Evaluar_Expresion(l.Componente_x);
                Evaluar_Expresion (l.Componente_y);
                Biblioteca.Puntos[l.Identificador] = l;
                return null;
            }
            if( nodo is Measure o)
            {
                var x1 = Evaluar_Expresion(o.P1.Componente_x);
                var y1 = Evaluar_Expresion(o.P1.Componente_y);
              
                var x2 = Evaluar_Expresion(o.P2.Componente_x);
                var y2 = Evaluar_Expresion(o.P2.Componente_y);
