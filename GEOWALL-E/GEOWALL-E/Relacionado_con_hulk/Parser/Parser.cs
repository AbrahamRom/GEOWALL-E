...
namespace GEOWALL_E
{
    ...
    class Parser
    {
        ...
        public Arbol Parse()
        {
            ...
            Lista.Add(expresion);
            if (Verificandose.Tipo is Tipo_De_Token.punto_y_coma)
            {
                ...
                case Tipo_De_Token.measure_Keyword:
                    {
                        ...
                        if (Verificandose.Tipo != Tipo_De_Token.point_Expresion)
                        {
                            errores.Add($"! SYNTAX ERROR : Expected <{"point_Expresion"}> in position <{_posicion}>");
                        }
                        var P1 = (Punto) Parse_Expresion();
                        Match(Tipo_De_Token.coma);
