...
namespace GEOWALL_E.Relacionado_con_hulk.Geometria.Intersections
{
    public class Intersections 
    {
        ...
        Secuencias_Evaluada PointInFigure(Punto punto, ILugarGeometrico figura)
        {
            switch (figura)
            {
                case Punto a:
        ...
        Secuencias_Evaluada PuntoIntPunto(Punto p1, Punto p2)
        {
        ...
        Secuencias_Evaluada PuntoIntLine(Punto p1, Line line)
        {
        ...
        bool PointInLine(Punto p1, Func<double,double> recta)
        {
        ...
        Secuencias_Evaluada PuntoIntSegment(Punto p1, Segment segment)
        {
        ...
        Secuencias_Evaluada PuntoIntArc(Punto p1, Arc arc)//falta
        {
            return new Secuencias_Evaluada();
        }
        Secuencias_Evaluada PuntoIntCircle(Punto p1, Circle circle)//falta
        {
            return new Secuencias_Evaluada();
        }
        Secuencias_Evaluada PuntoIntRay(Punto p1, Ray ray)//falta
        {
            return new Secuencias_Evaluada();
        }
        #endregion
